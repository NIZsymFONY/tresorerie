var Charts = function() {
	...
	var runChart3 = function() {
		...
		d3.json('http://127.0.0.1/recu_espece_projectht/web/assets/plugins/nvd3/json/stackedAreaData.txt', function(data) {
			nv.addGraph(function() {
	...
	var runChart5 = function() {
		d3.json('./stat-par-type/result-ajax/', function(data) {
			nv.addGraph(function() {
	...
	var runChart6 = function() {
		d3.json("http://127.0.0.1/recu_espece_projectht/web/assets/plugins/nvd3/json/linePlusBarData.json", function(error, data) {
			nv.addGraph(function() {
	...
	var runChart7 = function() {
		d3.json('http://127.0.0.1/recu_espece_projectht/web/assets/plugins/nvd3/json/cumulativeLineData.json', function(data) {
			nv.addGraph(function() {
		...
		/*nv.addGraph(function() {
			var chart = nv.models.pieChart().x(function(d) {
				...
				return d.value;
                        ...
                        d3.json('./stat-par-enc/result-ajax/', function(data) {
			d3.select("#demo-chart-9 svg").datum(data).transition().duration(350).call(chart);
                        });
			return chart; 
		});
